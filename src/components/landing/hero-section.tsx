        ...
        >
          <div className="text-center md:text-left">
            ...
            <motion.p
              ...
              variants={itemVariants}
            >
              Unihub is the ultimate platform for students to connect, share ideas, and build amazing projects together. Find your next collaborator and bring your vision to life.
            </motion.p>
            <motion.div
